...
Estratégia adotada (releases manuais + instalador por cima, preservando `data/`): **[informacoes/atualizacao-software.md](informacoes/atualizacao-software.md)**  
Checklist antes de enviar uma versão: **[informacoes/checklist-release.md](informacoes/checklist-release.md)**
...
- Python 3.11+ com `pip install -r requirements.txt` (build: `pip install -r requirements-build.txt`)
